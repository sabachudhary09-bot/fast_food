...
urlpatterns = [
    ...
    path('', views.index_page, name='index_pg'),
    path('our-menu/', views.menu_page, name='menu_pg'),
    path('offers/', views.offers_page, name='offers_pg'),
    path('location/', views.location_page, name='location_pg'),
